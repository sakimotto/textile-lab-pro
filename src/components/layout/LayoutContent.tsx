...
import { Microscope, Activity, Beaker, Clock, FileText, ClipboardList, Briefcase, Printer, Calendar as CalendarIcon } from 'lucide-react'
...
const latestRequests = [
  { client: 'Acme Textiles', test: 'Durability Test', date: new Date('2024-02-01') },
  { client: 'Beta Fabrics', test: 'Moisture Analysis', date: new Date('2024-02-02') },
  { client: 'Gamma Industries', test: 'Color Testing', date: new Date('2024-02-03') }
]

const jobsInWork = [
  { client: 'Delta Corp', test: 'Abrasion Test', date: new Date('2024-02-04') },
  { client: 'Epsilon Ltd', test: 'Environmental Test', date: new Date('2024-02-05') }
]

const allEvents = [...latestRequests, ...jobsInWork]
                              ...
                              <div className="space-y-2">
                                {allEvents
                                  .filter(event => 
                                    ...
                                    event.date.getFullYear() === props.day.date.getFullYear()
                                  )
                                  .map((event, index) => (
                                    <div key={index} className="flex items-center justify-between">
                                      <div>
